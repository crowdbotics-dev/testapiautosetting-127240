...
## Project Structure
    ...
    ├── testapiautosetting_127240  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127240`
...
2. Clone this repo and `cd testapiautosetting_127240`
